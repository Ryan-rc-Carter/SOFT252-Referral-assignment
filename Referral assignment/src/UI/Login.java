...
public class Login extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel19.setText("Return books by using the search above.");
        ...
        jLabel16.setText("Request 1 week extension");
        ...
        jRequestExtension.setText("Submit request");
        jRequestExtension.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jRequestExtensionActionPerformed(evt);
            }
        });
                ...
                .addGroup(jPanel7Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel7Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel7Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(jPanel7Layout.createSequentialGroup()
                                .addComponent(jExtensionID, javax.swing.GroupLayout.PREFERRED_SIZE, 30, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                                .addComponent(jLabel17)
                                .addGap(51, 51, 51)
                                .addComponent(jExtensionName, javax.swing.GroupLayout.PREFERRED_SIZE, 160, javax.swing.GroupLayout.PREFERRED_SIZE))))
                    .addGroup(jPanel7Layout.createSequentialGroup()
                        .addGap(115, 115, 115)
        ...
        jPanel7Layout.setVerticalGroup(
            ...
            .addGroup(jPanel7Layout.createSequentialGroup()
                ...
                .addGroup(jPanel7Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jExtensionID, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(jLabel17)
        ...
        jUserBooksPanelLayout.setHorizontalGroup(
            ...
            .addGroup(jUserBooksPanelLayout.createSequentialGroup()
                .addContainerGap()
                .addGroup(jUserBooksPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                        ...
                        .addGroup(jPanel6Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addGroup(jPanel6Layout.createSequentialGroup()
                                ...
                                .addGroup(jPanel6Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    ...
                                    .addComponent(jNewResourceType, javax.swing.GroupLayout.DEFAULT_SIZE, 187, Short.MAX_VALUE)))
                            .addGroup(jPanel6Layout.createSequentialGroup()
                                .addGroup(jPanel6Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                ...
                                .addGap(18, 18, 18)
                                .addGroup(jPanel6Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                    .addComponent(jNewResourceName, javax.swing.GroupLayout.DEFAULT_SIZE, 184, Short.MAX_VALUE)
                                    .addComponent(jNewResourceClass)))
                            .addComponent(jLabel11)))
                    .addGroup(jPanel6Layout.createSequentialGroup()
                        .addGap(49, 49, 49)
                        .addComponent(jError, javax.swing.GroupLayout.PREFERRED_SIZE, 237, javax.swing.GroupLayout.PREFERRED_SIZE)))
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                            .addComponent(jUserBooksPanel, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                            .addGroup(layout.createSequentialGroup()
    ...
    private void jLoginButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jLoginButtonActionPerformed
        ...
        if(jUserName.getText().equals(clientOneUsername)){
            ...
            if(jPassword.getText().equals(clientOnePassword)){
                ...
                currentUser = new Client("Jane", "Smith", false, "Jane", "Smith");
    ...
    private void jAdminSendActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jAdminSendActionPerformed
        ...
        if(jAdminMessage.getText() != null){
            ...
            message = new Message(currentUser.getFirstName(), jAdminMessage.getText());
    ...
    private void jCreateResourceActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jCreateResourceActionPerformed
        ...
        //Check if a name has been given, the 
        if(jNewResourceName.getText() != null){
            if(jNewResourceClass.getText() != null){
                if(jNewResourceType.getText() != null ){
                    ...
                    message = new Message("new Resource Available: ", "A new resource is available - " + name);
    ...
    private void jRequestExtensionActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jRequestExtensionActionPerformed
        // TODO add your handling code here:
        
        Extension extension = new Extension(currentUser.getFirstName(), borrowID.getResourceID(), borrowID.getResourceName());
        
        Message message = new Message("Automated message: ","Extension request for " + borrowID.getResourceName() + " has been submitted");
    ...
    public void LoadExtensionRequests(){
        ...
        for (Borrow i : borrowedList){
            if(i.getBorrower().equals(currentUser.getFirstName())){
                ...
                if(i.getReturnDate().isAfter(currentDate)){
                    ...
                    Message message = new Message("Automated message: ", currentUser.getFirstName() + " " + currentUser.getLastName() + " Your resource '" + i.getResourceName() + "' is due to be returned");
                    ...
                    Message message = new Message("Automated message: ", currentUser.getFirstName() + " " + currentUser.getLastName() + " Your resource '" + i.getResourceName() + "' is OVERDUE ");
